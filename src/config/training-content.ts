  ...
  extractionSteps: [
    {
      ...
      description: "Sign in and open Home. Watch the video training placeholder and read Here's how it works.",
      tips: ["Start here every time you log in", "The three steps are shown as big cards"],
      href: "/dashboard",
    },
    {
      step: 2,
      title: "Quick setup (if asked)",
      icon: "activity" as TrainingIconId,
      description: "If you see Quick setup, press Start quick setup. It connects your account and suggests a daily goal.",
      tips: ["Takes about 30 seconds", "The dollar amount is a goal, not money in the bank"],
      href: "/dashboard",
    },
    {
      step: 3,
      title: "Save your daily goal",
      icon: "wallet" as TrainingIconId,
      description: "Save the daily goal when it appears, then use Pick your topic → Add your links → Turn on your website.",
      tips: ["Finish setup before launching your first website", "Support is always in the sidebar"],
      href: "/dashboard",
    },
